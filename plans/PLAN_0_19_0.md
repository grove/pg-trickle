...
**Milestone:** v0.19.0 — PostgreSQL 17 Support
**Status:** 🚧 In progress
**Last updated:** 2026-04-12


This document defines the recommended implementation order for all v0.19.0
roadmap items. See [ROADMAP.md §v0.19.0](../ROADMAP.md#v0190--postgresql-17-support)
...
- **PG17-11:** Verify `ALTER EXTENSION pg_trickle UPDATE` (0.18.0 → 0.19.0)
...
| 11 | PG17-11 | Upgrade path test (0.18.0 → 0.19.0) | 2–4h | Depends on PG17-9 |
...
| PG17-11 | Upgrade path test (0.18.0 → 0.19.0) | ⬜ Not started |
...
- [ ] `PG17-11`: Extension upgrade path tested (`0.18.0 → 0.19.0`) on both PG 17 and PG 18
