...
| P1 | `src/dvm/operators/outer_join.rs` | Add execution-backed left-join cases: unmatched-to-matched, matched-to-unmatched, and nested left join. |
| P1 | `src/dvm/operators/full_join.rs` | Add execution-backed full-join transitions for both-sided unmatched/matched flips. |
