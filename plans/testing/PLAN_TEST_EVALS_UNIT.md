...
- Join execution-backed coverage now spans inner (6 tests + 2 three-table chain tests), left (7 tests), full (8 tests), and natural-join-style (5 tests across all three join types). Remaining: nested natural join execution (nested left and full join are now covered)
