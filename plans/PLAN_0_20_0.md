# PLAN_0_19_0.md — v0.20.0 Implementation Order

**Milestone:** v0.20.0 — PostgreSQL 17 Support
**Status:** 🚧 In progress
**Last updated:** 2026-04-12


This document defines the recommended implementation order for all v0.20.0
roadmap items. See [ROADMAP.md §v0.20.0](../ROADMAP.md#v0200--postgresql-17-support)
...
- **PG17-11:** Verify `ALTER EXTENSION pg_trickle UPDATE` (0.19.0 → 0.20.0)
