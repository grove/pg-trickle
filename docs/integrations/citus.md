...
- [CHANGELOG — v0.32.0](https://github.com/grove/pg-trickle/blob/main/CHANGELOG.md) (stable naming and frontier foundations)
- [CHANGELOG — v0.33.0](https://github.com/grove/pg-trickle/blob/main/CHANGELOG.md) (distributed CDC and stream tables)
- [CHANGELOG — v0.34.0](https://github.com/grove/pg-trickle/blob/main/CHANGELOG.md) (automated distributed CDC scheduler & shard rebalance auto-recovery)
