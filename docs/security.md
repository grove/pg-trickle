...
> version is served by the [pg_trickle docs site](https://trickle-labs.github.io/pg-trickle/);
> on GitHub the source is [SECURITY.md](https://github.com/trickle-labs/pg-trickle/blob/main/SECURITY.md).
