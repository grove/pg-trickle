...
CREATE  FUNCTION pgtrickle."st_refresh_stats"() RETURNS TABLE (
	...
	"downstream_publication" TEXT  /* core::option::Option<alloc::string::String> */
)
STRICT  
LANGUAGE c /* Rust */
...
CREATE  FUNCTION pgtrickle."scheduler_overhead"() RETURNS TABLE (
	...
	"df_refresh_fraction" double precision,  /* core::option::Option<f64> */
	"avg_refresh_ms" double precision,  /* core::option::Option<f64> */
	"avg_df_refresh_ms" double precision,  /* core::option::Option<f64> */
	"total_refresh_time_s" double precision,  /* core::option::Option<f64> */
	"df_refresh_time_s" double precision  /* core::option::Option<f64> */
)
STRICT 
LANGUAGE c /* Rust */
