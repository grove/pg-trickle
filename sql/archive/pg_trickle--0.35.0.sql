...
CREATE TABLE IF NOT EXISTS pgtrickle.pgt_stream_tables (
    ...
    -- v0.35.0 UX-SHADOW: zero-downtime schema evolution columns
...
-- A11 (v0.35.0): Index for SLA summary queries and retention pruning.
CREATE INDEX IF NOT EXISTS pgt_refresh_history_start_time_idx ON pgtrickle.pgt_refresh_history (start_time DESC);

-- v0.35.0 UX-SUB: reactive NOTIFY subscriptions
...
-- CIT-4 / COORD-16: Per-worker replication slot tracking view.
...
-- v0.34.0: Extended with last_polled_at, lease_holder, lease_acquired_at,
-- lease_expires_at, and lease_health columns.
...
-- src/lib.rs:1086
-- requires:
--   pg_trickle_outbox_inbox_catalog
...
CREATE  FUNCTION pgtrickle."create_inbox"(
	...
	"p_max_retries" INT DEFAULT 3, /* i32 */
	"p_schedule" TEXT DEFAULT '1s', /* & str */
	"with_dead_letter" bool DEFAULT true, /* bool */
...
/* <begin connected objects> */
-- src/api/mod.rs -- v0.35.0 UX-SUB: subscribe
...
/* <begin connected objects> */
-- src/api/mod.rs -- v0.35.0 UX-SUB: unsubscribe
...
/* <begin connected objects> */
-- src/api/mod.rs -- v0.35.0 UX-SUB: list_subscriptions
...
/* <begin connected objects> */
-- src/api/mod.rs -- v0.35.0 F17: sla_summary
...
/* <begin connected objects> */
-- src/api/mod.rs -- v0.35.0 A23: explain_stream_table
...
/* <begin connected objects> */
-- src/api/mod.rs -- v0.35.0 UX-STATUS: view_evolution_status
