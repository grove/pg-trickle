-- pg_trickle v0.1.3 — real installable SQL baseline for upgrade testing.
--
-- This file is derived from the pgrx-generated v0.2.0 SQL with the 11
-- functions added in v0.2.0 removed. The catalog table structure is
-- identical to v0.2.0 because upgrade E2E tests run against the v0.2.1
-- binary (which requires the current catalog schema).
--
-- Functions present in v0.1.3 (18 total):
--   create_stream_table, alter_stream_table, drop_stream_table,
--   resume_stream_table, refresh_stream_table, parse_duration_seconds,
--   pgt_status, st_refresh_stats, get_refresh_history, st_auto_threshold,
--   get_staleness, slot_health, explain_st, check_cdc_health,
--   pg_trickle_hash, pg_trickle_hash_multi, _on_ddl_end, _on_sql_drop
--
-- Functions added in v0.2.0 (NOT present here):
--   list_sources, change_buffer_sizes, _signal_launcher_rescan,
--   refresh_timeline, pgt_ivm_handle_truncate, health_check,
--   pgt_ivm_apply_delta, trigger_inventory, version,
--   dependency_tree, diamond_groups
--
-- Used by: tests/build_e2e_upgrade_image.sh (upgrade E2E image)
-- Also used by: scripts/check_upgrade_completeness.sh (function diff baseline)
...
CREATE  FUNCTION pgtrickle."create_stream_table"(
	"name" TEXT, /* &str */
	"query" TEXT, /* &str */
	"schedule" TEXT DEFAULT '1m', /* core::option::Option<&str> */
	"refresh_mode" TEXT DEFAULT 'DIFFERENTIAL', /* &str */
