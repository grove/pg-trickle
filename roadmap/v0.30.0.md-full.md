...
**Status: ✅ Released (v0.30.0).** Derived from [plans/PLAN_OVERALL_ASSESSMENT_3.md](plans/PLAN_OVERALL_ASSESSMENT_3.md) §3, §4, §7, §8.
...
| UX-5 | Document SNAP/PLAN/CLUS/METR functions in SQL_REFERENCE | M | P1 |
...
**UX-5** — The SNAP/PLAN/CLUS/METR functions (`snapshot_stream_table`,
`restore_from_snapshot`, `list_snapshots`, `recommend_schedule`,
`schedule_recommendations`, `cluster_worker_summary`, `metrics_summary`)
have no dedicated CLI/dashboard integration.
Add SQL reference docs and observability guidance for all eight functions.
...
| Phase 6 | P1/P2/P3 docs & UX: UX-3 through UX-18, SNAP/PLAN/CLUS/METR docs | Days 27–34 |
...
- [ ] UX-5: SNAP/PLAN/CLUS/METR functions fully documented in SQL_REFERENCE (deferred to v0.31.0)
