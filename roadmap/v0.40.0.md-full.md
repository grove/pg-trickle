...
| O40-5 | dbt and relay parity for recent operational surface | M | P2 |
...
or invoke each surface. Add an operator guide for relay credentials that
...
**O40-5 — dbt and relay parity for recent operational surface.**
...
| T-O40-4 | Ecosystem parity tests for dbt and relay | M | P2 |
...
**T-O40-4.**
Add lightweight checks that relay and dbt examples can surface recent
...
- [ ] O40-5: dbt and relay expose the operational surface added in recent releases
