...
- [ ] All four new tutorials complete, SQL examples verified, linked from `docs/introduction.md` and `docs/SUMMARY.md`
- [ ] `docs/SECURITY_GUIDE.md` has copy-paste GRANT templates verified against a running instance
- [ ] `docs/WHATS_NEW.md` has entries for all versions
- [ ] Consistency pass grep checks pass with zero violations
- [ ] `just lint` passes with zero warnings
- [ ] Docs site (`mdbook build`) builds with zero broken links
...
| ID | Title | Status |
|----|-------|--------|
| DOC-NEW-24 | docs/tutorials/FIRST_DASHBOARD.md | ☐ Planned |
| DOC-NEW-25 | docs/tutorials/EVENT_SOURCING.md | ☐ Planned |
| DOC-NEW-26 | docs/tutorials/BACKFILL_AND_MIGRATION.md | ☐ Planned |
| DOC-NEW-27 | docs/tutorials/SECURITY_HARDENING.md | ☐ Planned |
| DOC-P2-11 | SECURITY_GUIDE.md role templates | ☐ Planned |
| DOC-P2-12 | WHATS_NEW.md backfill | ☐ Planned |
| DOC-P2-13 | HYBRID_SEARCH_PATTERNS expansion | ☐ Planned |
| DOC-P2-14 | PER_TENANT_ANN_PATTERNS expansion | ☐ Planned |
| DOC-P2-15 | Link inconsistency fixes | ☐ Planned |
| DOC-P2-16 | PERFORMANCE_COOKBOOK §13 examples | ☐ Planned |
| DOC-P2-17 | SECURITY_MODEL supply-chain TODOs | ☐ Planned |
| DOC-P3-18 | FAQ.md link conversion | ☐ Planned |
| DOC-P3-19 | DVM_OPERATORS.md index | ☐ Planned |
| DOC-P3-20 | VECTOR_RAG_STARTER parameter docs | ☐ Planned |
| DOC-P3-21 | tuning-refresh-mode threshold prose | ☐ Planned |
| DOC-P3-22 | multi_db_refresh_broker status banner | ☐ Planned |
| DOC-CONS-28 | Terminology sweep | ☐ Planned |
| DOC-CONS-29 | Capitalisation sweep | ☐ Planned |
| DOC-CONS-30 | Code style sweep | ☐ Planned |
| DOC-CONS-31 | Cross-link audit | ☐ Planned |
